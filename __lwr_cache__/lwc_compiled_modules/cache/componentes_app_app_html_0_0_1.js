...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  }), $cmp.navigationItems.Experiencia.visible ? api_element("tempalte", stc3, [api_custom_element("componentes-experiencia", _componentesExperiencia, {
    key: 6,
    on: {
      "load": _m2 || ($ctx._m2 = api_bind($cmp.setStatusLoad))
    }
  })]) : null, $cmp.navigationItems.Formación.visible ? api_element("tempalte", stc4, [api_custom_element("componentes-formacion", _componentesFormacion, {
    key: 8,
    on: {
      "load": _m3 || ($ctx._m3 = api_bind($cmp.setStatusLoad))
    }
  })]) : null, $cmp.navigationItems.Habilidades.visible ? api_element("tempalte", stc5, [api_custom_element("componentes-habilidades", _componentesHabilidades, {
    key: 10,
    on: {
      "load": _m4 || ($ctx._m4 = api_bind($cmp.setStatusLoad))
    }
  })]) : null, $cmp.navigationItems.Contacto.visible ? api_element("tempalte", stc6, [api_custom_element("componentes-contacto", _componentesContacto, stc7)]) : null]) : null])];
